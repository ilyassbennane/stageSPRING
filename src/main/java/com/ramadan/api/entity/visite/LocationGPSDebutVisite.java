...
@Entity
@NoArgsConstructor
@Table(name = "ns_location_gps_debut_visite")
@Where(clause = "is_delete = false and is_statut = true")
public class LocationGPSDebutVisite extends BaseModel {

	private static final long serialVersionUID = 1L;

	@OneToOne
	@JoinColumn(name = "location_gps_debut_visite_id")
	private LocationGPSVisite locationGPSVisite;
