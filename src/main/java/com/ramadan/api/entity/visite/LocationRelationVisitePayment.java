...
@Entity
@NoArgsConstructor
@Table(name = "ns_location_relation_visite_payment")
@Where(clause = "is_delete = false and is_statut = true")
public class LocationRelationVisitePayment extends BaseModel {

	@OneToOne
	@JoinColumn(name = "relation_visite_payment_id")
	private RelationVisitePayment payment;
