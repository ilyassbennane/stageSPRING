...
@Entity
@NoArgsConstructor
@Table(name = "ns_location_relation_visite_deadline")
@Where(clause = "is_delete = false and is_statut = true")
public class LocationRelationVisiteDeadline extends BaseModel {

	@OneToOne
	@JoinColumn(name = "relation_visite_deadline_id")
	private RelationVisiteDeadline relationVisiteDeadline;
