...
@Entity
@NoArgsConstructor
@Table(name = "ns_family_costumer")
@Where(clause = "is_delete = false and is_statut = true")
public class FamilyCostumer extends BaseModel {
	...
	private FamilyCostumer parent;

	@OneToMany(mappedBy = "parent", cascade = CascadeType.ALL)
	private Set<FamilyCostumer> children = new HashSet<>();
