...
@Entity
@NoArgsConstructor
@Table(name = "ns_location_gps_address_consomer")
@Where(clause = "is_delete = false and is_statut = true")
public class LocationGPSAddressCostumer extends BaseModel {

	private static final long serialVersionUID = 1L;

	@ManyToOne
	@JoinColumn(name = "address_costumer_id")
	private AddressCostumer addressCostumer;
