...
@Entity
@NoArgsConstructor
@Table(name = "ns_actions_module_mobile")
@Where(clause = "is_delete = false and is_statut = true")
public class ActionsModuleMobile extends BaseModel {
	...
	@ManyToOne
	@JoinColumn(name = "module_mobile_id")
	private ModulesMobile modulesMobile;
