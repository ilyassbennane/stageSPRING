...
/**
 * DTO for retrieving {@link com.ramadan.api.entity.user.HistoriqueLogin}
 */
@Data
@NoArgsConstructor
public class HistoriqueLoginResponseDto implements Serializable {

    @Schema(description = "UUID of the historical login")
    @JsonProperty("uuid")
    private String uuid;
