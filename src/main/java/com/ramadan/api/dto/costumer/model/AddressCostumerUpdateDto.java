...
@Data
@NoArgsConstructor
@Schema(name = "AddressCostumerUpdateDto")
public class AddressCostumerUpdateDto {
	...
	@Schema(name = "address1", type = "string", description = "Address1 line 1", example = "123 Main Street", required = true)
	private String address1;

	@JsonProperty("address2")
	@Schema(name = "address2", type = "string", description = "Address line 2", example = "Suite 456", required = false)
	...
	@Schema(name = "address3", type = "string", description = "Address line 3", example = "Building A", required = false)
    ...
    private LocationGPSUpdateCostumerDto locationGPSRequestDto;
}
